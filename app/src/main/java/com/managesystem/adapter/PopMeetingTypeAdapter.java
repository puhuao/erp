 ...
 */
public class PopMeetingTypeAdapter extends BaseListAdapter<MeetingType> {

    public PopMeetingTypeAdapter(Activity context) {
        super(context);
    }
    @Override
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        MeetingType department = mList.get(position);
        holder.name.setText(department.getServicetypeName());
        return convertView;
    }
