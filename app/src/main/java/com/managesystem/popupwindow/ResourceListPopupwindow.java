 ...
 */
public class ResourceListPopupwindow extends PopupWindow {
    ListView listView ;
    Activity mContext;
    ResourcePersonAdapter adapter;
    private List<ResourcePersonModel> list;
    public ResourceListPopupwindow(Activity context, final List<ResourcePersonModel> list){
        super();
        mContext = context;
        this.list = list;
        ...
        adapter = new ResourcePersonAdapter(context);
