 ...
 */
public class MeetingRoomSelectPopupwindow extends PopupWindow {
    ListView listView ;
    Activity mContext;
    PopMeetingRoomAdapter adapter;
    private List<MeetingRoom> list;
    public MeetingRoomSelectPopupwindow(Activity context, final List<MeetingRoom> list){
        super();
        mContext = context;
        this.list = list;
        ...
        adapter = new PopMeetingRoomAdapter(context);
