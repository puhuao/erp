...
import com.managesystem.adapter.PopAreaAdapter;
...
public class AreaSelectPopupwindow extends PopupWindow {
    ListView listView ;
    Activity mContext;
    PopAreaAdapter adapter;
    private List<String> list;
    public AreaSelectPopupwindow(Activity context, final List<String> list){
        super();
        mContext = context;
        this.list = list;
        ...
        adapter = new PopAreaAdapter(context);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                dissmisPopupwindow();
                AreaSelectEvent event = new AreaSelectEvent(list.get(position));
