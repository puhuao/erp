 ...
 */
public class DepartmentSelectPopupwindow extends PopupWindow {
    ListView listView ;
    Activity mContext;
    PopDepartmentAdapter adapter;
    private List<Department> list;
    public DepartmentSelectPopupwindow(Activity context, final List<Department> list){
        super();
        mContext = context;
        this.list = list;
        ...
        adapter = new PopDepartmentAdapter(context);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                dissmisPopupwindow();
                DepartmentSelectEvent event = new DepartmentSelectEvent(list.get(position));
