 ...
 */
public class MeetingSignPersonPopupwindow extends PopupWindow {
    ListView listView ;
    Activity mContext;
    PopMeetingSignPersonAdapter adapter;
    private List<Users> list;
    public MeetingSignPersonPopupwindow(Activity context, final List<Users> list){
        super();
        mContext = context;
        this.list = list;
        ...
        adapter = new PopMeetingSignPersonAdapter(context);
