 ...
 */
public class ResourceTypeSelectPopupwindow extends PopupWindow {
    ListView listView ;
    Activity mContext;
    PopResourceTypeAdapter adapter;
    private List<ResourceType> list;
    public ResourceTypeSelectPopupwindow(Activity context, final List<ResourceType> list){
        super();
        mContext = context;
        this.list = list;
        ...
        adapter = new PopResourceTypeAdapter(context);
