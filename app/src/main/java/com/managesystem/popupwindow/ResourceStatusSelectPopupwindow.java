...
import com.managesystem.adapter.PopResourceStatusAdapter;
 ...
 */
public class ResourceStatusSelectPopupwindow extends PopupWindow {
    ListView listView ;
    Activity mContext;
    PopResourceStatusAdapter adapter;
    private List<Status> list;
    public ResourceStatusSelectPopupwindow(Activity context, final List<Status> list){
        super();
        mContext = context;
        this.list = list;
        ...
        adapter = new PopResourceStatusAdapter(context);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                dissmisPopupwindow();
                ResStatusSelectEvent event = new ResStatusSelectEvent(list.get(position));
