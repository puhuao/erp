...
import com.wksc.framwork.widget.LoadMoreNestListView;
...
public abstract class BaseNestListRefreshFragment<T> extends CommonFragment{
    protected int pageNo = 1;
    protected int pageSize = 20;
    @Bind(R.id.list_view)
    public LoadMoreNestListView listView;
    View empty;
    ArrayList<T> models ;
...
//            startRefresh();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        listView.setOnLoadMoreListener(new LoadMoreNestListView.OnLoadMoreListener() {
            @Override
