...
public class PersonalMeetingFragment extends CommonFragment {
    ...
    protected View createView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        container = (ViewGroup) inflater.inflate(R.layout.fragment_personal_meeting, null);
    ...
    private void initView() {
        ...
        NetFragmentAdapter adapter = new NetFragmentAdapter(getContext().getSupportFragmentManager());
